...
/**
 * Move and/or resize the rectangle to crop your image. You can also zoom with
 * the wheel of you mouse.
 * 
 * @author Christophe Le Besnerais URL:
...
public class ImageCropper extends JLayeredPane {
    ...
    public ImageCropper(BufferedImage image) {
        ...
        this.image = image;
        this.crop = new Rectangle(image.getWidth() / 5, image.getHeight() / 5, 3 * image.getWidth() / 5,
                3 * image.getHeight() / 5);
    ...
    private void changeCrop(boolean updatePanel) {
        ...
        if (updatePanel) {
            float ratio = (float) image.getWidth() / (float) getThumbbail().getWidth();
    ...
    private class InnerListener extends MouseAdapter
            implements ComponentListener, MouseMotionListener, MouseWheelListener {
        ...
        public void componentResized(ComponentEvent e) {
            ...
            float ratio = (float) getThumbbail().getWidth() / (float) image.getWidth();
        ...
        public void mouseWheelMoved(MouseWheelEvent e) {
            if ((e.getWheelRotation() > 0 && crop.x > 0 && crop.x + crop.width < image.getWidth() && crop.y > 0
                ...
                crop.setBounds(crop.x - ((newWidth - crop.width) / 2), crop.y - ((newHeight - crop.height) / 2),
                        newWidth, newHeight);
